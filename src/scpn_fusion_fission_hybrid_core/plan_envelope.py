...
# SCPN Fusion Fission Hybrid Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-FUSION-FISSION-HYBRID-CORE"
...
class PlanEnvelope:
    ...
    actionable
        Must be ``False``.
    binding
        SPO catalogue and reactor-registry pins; must equal the embedded
        :data:`~scpn_fusion_fission_hybrid_core.observability.CATALOGUE_BINDING`.
    plan_identifier
