...
# SCPN Fusion Fission Hybrid Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "5630da1cf8624d1be28f0eaf0926350aa7b273482d48b8b4fb80ebb4a012906c"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-FUSION-FISSION-HYBRID-CORE"
    assert NON_CLAIMS == (
