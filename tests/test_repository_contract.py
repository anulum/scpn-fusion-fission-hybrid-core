...
# SCPN Fusion Fission Hybrid Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_fusion_fission_hybrid_core/geometry/__init__.py",
    "src/scpn_fusion_fission_hybrid_core/geometry/device.py",
    "src/scpn_fusion_fission_hybrid_core/geometry/model.py",
    "src/scpn_fusion_fission_hybrid_core/geometry/cad.py",
    "requirements-dev.txt",
    "src/scpn_fusion_fission_hybrid_core/__init__.py",
    "src/scpn_fusion_fission_hybrid_core/configuration.py",
    "src/scpn_fusion_fission_hybrid_core/errors.py",
    "src/scpn_fusion_fission_hybrid_core/observability.py",
    "src/scpn_fusion_fission_hybrid_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_fusion_fission_hybrid_core/parameters.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-FUSION-FISSION-HYBRID-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_fusion_fission_hybrid_core import OWNED_CONFIGURATIONS, RegistryBinding
...
def test_typed_package_marker_exists() -> None:
    ...
    assert (REPO / "src" / "scpn_fusion_fission_hybrid_core" / "py.typed").is_file()
